...
//     File(pdfPath).copySync("${pdfPath.split('.pdf')[0]}iuur.pdf");
//     final documentManager =
//         await PdfDocumentManager.open("${pdfPath.split('.pdf')[0]}iuur.pdf");
//     RustPdfRenderer.instance().loadPdf(pdfPath);
//     Timer(const Duration(seconds: 10), () async {
//       log("caching");
//       //await RustPdfRenderer.instance().cacheAllPages();
//       log("finnished caching");
//     });
