...
class PdfPageGestureDetector extends ConsumerWidget {
  ...
  void onDoubleTap(WidgetRef ref) {
    ...
    if (appbarsVisibilityModel.areAppbarsVisibile) {
      ...
      for (var block in extractedText!.blocks) {
        for (var line in block.lines) {
          for (var element in line.elements) {
            ...
            final pageUncoveredHeight = screenHeight - bottomSheetHeight;
            if (element.isGestureWithinRange(
              ...
              wordInteractionModel.updateTappedWord(
                ...
                bottomSheetController: showWordExplanation(
                  context: context,
                  text: element.text,
...
PersistentBottomSheetController? showWordExplanation({
  required BuildContext context,
