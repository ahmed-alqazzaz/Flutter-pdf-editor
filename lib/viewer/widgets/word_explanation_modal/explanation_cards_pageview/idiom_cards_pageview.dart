...
import 'package:pdf_editor/viewer/widgets/word_explanation_modal/explanation_cards_pageview/generics/generics/generic_explanation_builder.dart';
...
class IdiomsCardsPageView extends StatelessWidget {
  const IdiomsCardsPageView(
      {super.key, required this.idioms, required this.height});
  final double height;
