...
class WordExplanationModal extends StatefulWidget {
  const WordExplanationModal({
    super.key,
    required this.text,
  ...
  @override
  State<WordExplanationModal> createState() => _WordExplanationModalState();
}

class _WordExplanationModalState extends State<WordExplanationModal> {
  ...
  late final BehaviorSubject<List<ArrowDirection>> _visibleNavigationArrows;
  late final BehaviorSubject<double> _topAreaSweepingOffset;

  @override
  void initState() {
    _visibleNavigationArrows = BehaviorSubject<List<ArrowDirection>>(
      sync: true,
    )..add([ArrowDirection.left]);
  ...
  void dispose() {
    ...
    _visibleNavigationArrows.close();
  ...
  Widget build(BuildContext context) {
    final double explanationCardsPageViewHeight =
        widget.height - ModalTopArea.height - expansionPanelHeight;
